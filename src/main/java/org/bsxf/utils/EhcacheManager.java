...
public class EhcacheManager {
	...
	*/
	...
	public static EmailConfig getEmailConfig() {
		//Cache cache = ehcacheManager.getCache(CACHE_NAME);
		Object element = get(EMAIL_KEY);
		if (element == null) {
			EmailConfigManager stationConfigManager = SpringContextHolder.getBean(EmailConfigManager.class);
			List<EmailConfig> slist = stationConfigManager.getAllEmailConfig();
