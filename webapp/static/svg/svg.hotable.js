...
;(function() {
  ...
  SVG.extend(SVG.Element, {
    ...
    hotable: function(constraint,lt) { 
      var start, drag, end
        , element = this
     ...
     if(firstClk){ 
        ...
        /* add while and end events to window */
	        ...
	        var rotation  = element.startPosition.rotation;
...
///
     ...
     // element.on('click', start)
      SVG.on(window, 'click', start) 
      /* disable draggable */
      element.fixed = function() {
        element.off('click', start)
        
        SVG.off(window, 'mousemove', drag)
        SVG.off(window, 'dbclick',   end)
