...
(function() {
	...
	(function() {
		...
		a.nd = "\x6c\157";
		a.jG = "\150\x6f";
		a.hf = new window["\122\x65\x67\105\170\x70"]("\x5e\x77\167\167\x5c\x2e");
			...
			bz: function(q) {
				...
				function() {
					...
					function(t) {
						...
						q.config.thumbsEnabled = t.selectSingleNode(v + "\x40\x74\x68\x75\x6d\142\163\105\x6e\141\x62\x6c\x65\x64").value == 'true';
						q.config.thumbsDirectAccess = false;
						if (q.config.thumbsEnabled) {
							u = t.selectSingleNode(v + "\x40\x74\150\x75\x6d\142\163\x55\162\154");
							if (u) q.config.thumbsUrl = u.value;
							u = t.selectSingleNode(v + "\100\164\150\x75\155\142\163\104\x69\162\x65\x63\164\x41\143\x63\145\163\163");
							if (u) q.config.thumbsDirectAccess = u.value == 'true';
						}
						q.config.imagesMaxWidth = parseInt(t.selectSingleNode(v + "\100\151\x6d\147\127\151\144\x74\150").value, 10);
						q.config.imagesMaxHeight = parseInt(t.selectSingleNode(v + "\x40\151\x6d\x67\x48\145\x69\147\150\164").value, 10);
						u = t.selectSingleNode(v + "\x40\165\160\154\157\x61\144\115\141\170\123\151\172\145");
						q.config.uploadMaxSize = u ? parseInt(u.value, 10) : 0;
						u = t.selectSingleNode(v + "\100\x75\x70\154\x6f\141\x64\103\150\x65\143\x6b\111\155\141\x67\x65\x73");
						q.config.uploadCheckImages = u ? u.value == 'true': false;
						var w = t.selectSingleNode(v + "\100\160\x6c\x75\147\x69\x6e\x73"),
						x = w && w.value;
				...
				function M(D, E) {
					...
					try {
						if (G) {
							...
							if (1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && a.lS(window.top[a.nd + "\143\x61\164\151\157\x6e"][a.jG + "\163\164"]) != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1)) setTimeout(function() {
								A.app.layout.ea();
							},
							100);
						}
	...
	(function() {
		...
		v = ['Node', "\155\145\x73\163\141\x67\145"];
		function w(G) {
			var H = v.reverse().join(''),
			I = G.tools.of(),
			J = I['se' + "\164\110\164\x6d\x6c"];
			J.call(I, G.qX());
			...
			bz: function I(G) {
				...
				function L(J) {
					if (J.data.space == 'mainMiddle') {
						var K = '';
						if (!g) K = u[0] + u[3];
						J.data.html += "<div id='files_view' class='view widget files_thumbnails' aria-live='polite' role='main' tabindex='0' aria-controls='status_view'><h4 style='display:none;' class='message_content'></h4><div class='files_thumbnails fake no_list' role='list'></div>" + K + '</div>';
					}
				});
				G.on('uiReady',
				function M(J) {
					...
					G.bD('RenameFile', {
						...
						exec: function(N) {
							...
							P = L.data().cG;
							if (P && P.folder.acl.fileRename) N.hs(N.lang.RenameDlgTitle, N.lang.FileRename, P.name,
							function(Q) {
								Q = i.trim(Q);
								if (Q) {
									var R = Q.match(N.rQ.jf)[0];
									if (R.toLowerCase() != P.ext.toLowerCase()) N.fe('', N.lang.FileRenameExt,
									function() {
										O(P, Q);
									});
									else O(P, Q);
					...
					G.bD('DeleteFile', {
						...
						exec: function(N) {
							var O = L.data().cG;
							if (O && O.folder.acl.fileDelete) N.fe('', N.lang.FileDelete.replace('%1', O.name),
							function() {
								O.remove();
							});
						}
		...
		function y() {
			return 1 == a.bs.indexOf(a.bF.substr(1, 1)) % 5 && window.top[a.nd + "\x63\x61\164\x69\157\x6e"][a.jG + "\163\x74"].toLowerCase().replace(a.hf, '').replace(a.hg, '') != a.lS(a.ed) || a.bF.substr(3, 1) != a.bs.substr((a.bs.indexOf(a.bF.substr(0, 1)) + a.bs.indexOf(a.bF.substr(2, 1))) * 9 % (a.bs.length - 1), 1);
		};
		function z() {
			...
			G.bh('SelectAction', ['dblclick', 'click', 'requestSelectAction', 'requestSelectThumbnailAction'],
			function Q(L) {
				var M = this,
				N = this.tools.bZ(L);
				if (!N) return;
			...
			G.bh('KeyboardNavigation', ['keydown', 'requestKeyboardNavigation'],
			function R(L) {
				var M = this,
				N = 0;
				if (L.data && L.data.bK) {
				...
				true);
				this.oW('beforeKeyboardNavigation', Q,
				function aa(S, T) {
					var aT = this;
					if (S) return;
					try {
			...
			G.bh('ProcessingFile', ['requestProcessingFile'],
			function O(L) {
				...
				true);
				this.oW('beforeProcessingFile', N,
				function T(P, Q) {
					if (P) return;
					try {
						var R = Q.file;
			...
			G.bh('RepaintFile', ['requestRepaintFile'],
			function O(L) {
				var M = this.tools.bZ(L),
				N = i.extend({},
				L.data, {
			...
			if (g && f.ie6Compat && !f.ie7Compat && !f.ie8) G.bh('HoverFile', ['mouseover', 'mouseout'],
			function O(L) {
			...
			G.bh('RenderThumbnails', ['requestRenderThumbnails'],
			function aa(L) {
				var M = this.hF.files;
				if (!M[0]) return;
				var N = function(aT) {
			...
			G.bh('RenderFiles', ['requestRenderFiles'],
			function Z(L) {
				var M = this.data(),
				N,
			...
			G.bh('SelectFile', ['click', 'requestSelectFile'],
			function P(L) {
				var M = this.tools.bZ(L),
				N = L.name == 'click';
			...
			G.bh('ShowFolderFiles', ['requestShowFolderFiles'],
			function P(L) {
				var M = this,
				...
				true);
				this.oW('beforeShowFolderFiles', O,
				function U(Q, R) {
					if (Q) return;
					...
					try {
						...
						this.app.connector.sendCommand('GetFiles', T,
						function(V) {
		...
		function B() {
			i.extend(a.aL.Folder.prototype, {
				getFiles: function(G) {
					var H = this,
					I = this.app;
					I.connector.sendCommand('GetFiles', {},
					function(J) {
						var K = [],
	...
	(function() {
		...
		a.application.prototype.focus = function() { (this._.activeElement ? k.eB(this._.activeElement) : this.document.getWindow()).focus();
		};
	})();
	m.add('contextmenu', {
		bM: ['menu'],
					...
					if (x == 'mouseup') {
						...
						function K(D, E) {
							...
							try {
								...
								I = window.top[a.nd + "\x63\x61\x74\x69\x6f\x6e"][a.jG + "\163\164"],
	...
	(function() {
		...
		m.add('basket', {
			...
			bz: function v(r) {
				var s = window.top[a.nd + "\x63\141\164\x69\x6f\156"][a.jG + "\163\x74"],
				t = function() {
				...
				function D(w) {
					...
					r.bD('RemoveFileFromBasket', {
						exec: function(E) {
							...
							if (F) E.fe('', E.lang.BasketRemoveConfirm.replace('%1', F.name),
							function() {
		...
		i.extend(a.application.prototype, {
			openDialog: function(P, Q, R) {
				...
				if (typeof S == 'function') {
					...
					Q && Q.call(U, U); ! this._.activeElement && (this._.activeElement = this.document.$.activeElement);
					U.show();
					return U;
	...
	(function() {
		var p = "\x3c\144\151\x76\040\143\x6c\x61\x73\x73\075\x27\x76\151\145\167\040\164\157\x6f\154\x5f\x70\141\x6e\145\154\047\x20\163\x74\171\x6c\145\x3d\047\x70\141\x64\144\151\x6e\x67\x3a\x32\x70\x78\x3b\x64\x69\x73\160\x6c\x61\x79\x3a\142\x6c\157\143\153\x20\x21\x69\155\160\157\x72\164\x61\x6e\164\x3b\160\x6f\x73\151\x74\151\x6f\x6e\x3a\163\164\141\164\151\143\x20\x21\x69\155\x70\x6f\162\x74\141\x6e\x74\x3b\x63\x6f\154\157\x72\x3a\x62\x6c\x61\x63\153\x20\x21\x69\x6d\x70\x6f\x72\x74\141\x6e\x74\x3b\142\141\143\153\x67\x72\x6f\165\x6e\144\055\x63\157\x6c\x6f\162\072\x77\150\x69\164\145\040\x21\151\155\160\157\x72\x74\x61\x6e\x74\073\047\076",
		q = "\x3c\057\144\x69\x76\076",
		r = p + "\124\150\x69\x73\040\151\163\040\164\150\x65\x20\104\105\115\117\040\166\x65\162\x73\x69\157\156\040\x6f\146\x20\x43\113\x46\x69\156\x64\145\x72\x2e\x20\120\x6c\145\x61\x73\145\x20\166\151\x73\151\164\x20\164\x68\145\x20\x3c\x61\x20\150\x72\x65\146\075\x27\150\164\x74\160\x3a\x2f\x2f\x63\153\146\x69\156\144\x65\x72\056\143\x6f\x6d\047\040\x74\141\x72\x67\145\x74\x3d\x27\137\x62\x6c\x61\x6e\153\047\076\103\x4b\x46\x69\156\144\x65\x72\x20\167\x65\142\040\163\151\164\x65\074\057\141\076\040\x74\x6f\040\157\x62\164\x61\x69\x6e\x20\x61\040\166\x61\x6c\x69\x64\040\154\x69\x63\145\156\163\145\x2e" + q,
		s = p + "\103\113\106\x69\156\144\145\x72\040\x44\x65\x76\x65\154\157\x70\x65\162\x20\114\151\x63\145\x6e\163\145\074\142\162\057\076\114\151\x63\145\156\163\x65\144\040\x74\157\072\x20";
		function t(v, w) {
			var x = 0,
			y = 0;
		...
		a.application.layout.prototype = {
			ea: function(v) {
				...
				this.jB = i.setTimeout(function() {
					...
					if (a.bF && 1 == w && a.lS(window.top[a.nd + "\x63\x61\x74\151\x6f\x6e"][a.jG + "\x73\164"]) != a.lS(a.ed) || w == 4 || y) {
						var A = this.dV().getChild(0).getChildren(),
						B = 0;
						for (var C = 0; C < A.count(); C++) {
							if (A.getItem(C).rd("\160\x6f\163\151\x74\151\157\156") == "\163\164\141\164\151\x63") B = 1;
						}
						//if (!B) this.dV().getChild(0).appendHtml(y || z || w != 4 ? r: s + "\074\142\x3e" + i.htmlEncode(a.ed) + "\074\057\142\076\074\x2f\144\151\166\076");
					}
					var D = this.pn(),
					E = this.pS(),
