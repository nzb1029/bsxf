...
<html>
	<head>
		<script type="text/javascript" src="${ctx }/static/data/akl/cost.js"></script>
	</script>
	</head>
	<body>
    <div id="table_center_header">
       ...
       <div id="table_center_info">
           ...
           <div id="table_center_info_text">每个地块的种植成本对比数据，包括传统方案和爱科农方案两组数据</div>
       </div>
        ...
        <div id="table_center_search_header">
            ...
            <button class="button_right" type="button" onclick="javascript:update()" id="add" >添加成本数据</button>
        </div>
