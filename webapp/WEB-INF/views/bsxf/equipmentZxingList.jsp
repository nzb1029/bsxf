	...
	<body>
       ...
       <div id="table_center_info">
           ...
           <div id="table_center_info_text">
          	 打印灭火器二维码，可选的打印方式：单个灭火器打印，批量打印，打印全部二维码， 点击打印按钮会下载PDF文件到本地 <br>
          	 单个打印：选中一条记录，点击批量打印<br>
          	 批量打印：选中多条记录，点击批量打印<br>
          	 打印全部：会将当前系统中所有的灭火器的二维码打印出来 <font color="red">（慎用，一般不需要）</font><br>
           </div>
       </div>
